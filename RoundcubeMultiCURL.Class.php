...
{
<<<<<<< HEAD // public function stop(){ // // Сообщение об окончании работы программы. // // В условии проверяем если
    включен режим отладки (debugEnabled=TRUE) и // // указание записи в лог-файл (writeLogEnabled==TRUE): // // вызываем
    функцию записи в лог-файл. // // Дата 2001.03.10 17:16:18 (формат MySQL DATETIME). // $msg_stop=date("Y.m.d") . " "
    ; // // Время (17:16:18). // $msg_stop .=date("H:i:s") . " " ; // // Сообщение об окончании обработки. // $msg_stop
    .="RC multi cURL stopping \n" ; // // Выводим сообщение. // //echo "\n" . "$msg_stop" ; // // Вызываем функцию
    записи в лог-файл. // $this->write_log_file($msg_stop);
    // }
    }
    ?>
    =======
