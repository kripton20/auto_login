...
//            $this->content_h['post'][$key] = curl_multi_getcontent($this->curls[$key]);
//            // Получаем данные POST - запроса отправляемые серверу.
//            //$this->curl_infocontent_post_info[$key] = curl_getinfo($value);
//            $this->curl_info['post'][$key] = curl_getinfo($value);
//            curl_multi_remove_handle($this->multiCurl, $this->curls[$key]);
//        }
//    }
//
...
//            $this->content_h['aut'][$key] = curl_multi_getcontent($this->curls[$key]);
//            $this->curl_info['aut'][$key] = curl_getinfo($value);
//            curl_multi_remove_handle($this->multiCurl, $this->curls[$key]);
//        }
//    }
