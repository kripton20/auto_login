...
// Удалим лог-файл работы программы Auto Multi Login.
/**
* unlink — удаляет файл.
* unlink(string $filename, ?resource $context = null): bool
* Функция удаляет файл filename.
* При неудачном выполнении функция вызовет ошибку уровня E_WARNING.
* @var filename Путь к файлу.
* @var context  Ресурс (resource) контекста потока.
* Функция удалит символическую ссылку, если файл — символическая ссылка.
* Функция возвращает true, если выполнилась успешно, или false, если
* возникла ошибка.
*/
/**
...
* @var filename Путь к файлу или каталогу.
* Функция возвращает true, если файловая система содержит файл или каталог
* по пути filename, иначе возвращает false.
*/
